...
$privacyContent = $settings['privacy_policy'] ?? 'No Privacy Policy published yet.';
$lastUpdated = $conn->query("SELECT updated_at FROM terms_history WHERE type = 'privacy_policy' ORDER BY updated_at DESC LIMIT 1")->fetch_assoc();
    ...
    <div class="row justify-content-center">
        <div class="col-lg-10 card p-4 p-md-5 shadow-sm border-0" style="border-radius: 20px;">
            <div class="text-center mb-5">
                <h1 class="display-5 fw-bold" style="font-family: 'Playfair Display', serif; color: #1e3a5f;">Privacy Policy</h1>
            ...
            <div class="privacy-content" style="font-size: 16px; line-height: 1.8; color: #475569;">
                <?= nl2br($privacyContent) ?>
